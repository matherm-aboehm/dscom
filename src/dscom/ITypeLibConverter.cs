...
public interface ITypeLibConverter
{
    ...
    /// <param name="notifySink"><see cref="T:System.Runtime.InteropServices.ITypeLibImporterNotifySink" /> interface implemented by the caller.</param>
    ...
    AssemblyBuilder? ConvertTypeLibToAssembly([MarshalAs(UnmanagedType.Interface)] object typeLib,
        string asmFileName, TypeLibImporterFlags flags, ITypeLibImporterNotifySink? notifySink, byte[]? publicKey,
...
#endif
    AssemblyBuilder? ConvertTypeLibToAssembly([MarshalAs(UnmanagedType.Interface)] object typeLib,
        string asmFileName, int flags, ITypeLibImporterNotifySink? notifySink, byte[]? publicKey,
#pragma warning disable SYSLIB0017
        StrongNameKeyPair? keyPair,
#pragma warning restore SYSLIB0017
